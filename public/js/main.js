...
},{"./GeosuggestItem":4,"./input-attributes":5,"react":161}],4:[function(require,module,exports){
'use strict';
...
},{"./components/Weather.jsx":164,"react":161,"react-dom":2}],164:[function(require,module,exports){
"use strict";
...
var Weather = React.createClass({
    ...
    componentWillMount: function componentWillMount() {
        ...
        fetch(weatherData).then(function (res) {
            return res.json();
        }).then(function (json) {
            _this.setState({
                weather: json
    ...
    render: function render() {
        if (this.state.weather) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    "div",
                    { className: "col-xs-8 col-xs-offset-2 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 weatherApp" },
                    React.createElement(
                        "div",
                        { className: "panel panel-body panel-danger" },
                        React.createElement(
                            "div",
                            { className: "row" },
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        "div",
                                        { className: "searchGlassContainer", onClick: this.show },
                                        React.createElement("i", {
                                            className: "fa fa-search searchGlass" })
                                    )
                                ),
                                React.createElement(
                                    "div",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "div",
                                    { className: "col-xs-6 currentIcon" },
                                    React.createElement("img", { src: currentIcon, alt: "" })
                                ),
                                React.createElement(
                                    "div",
                                    { className: "col-xs-6 currentTemp" },
                                    Math.floor(this.state.weather.list[0].temp.day),
                                    "°"
                                )
                            ),
                            React.createElement(
                                ...
                                React.createElement(
                                    "div",
                                    { className: "col-xs-6 currentDescription" },
                                    this.state.weather.list[0].weather[0].description
                                ),
                                React.createElement(
                                    "div",
                                    { className: "col-xs-6 currentWind" },
                                    React.createElement("i", { className: "fa fa-cloud fa-2x" }),
                                    " ",
                                    this.state.weather.list[0].speed,
                                    " MPH"
                                )
                            )
                        ),
                        React.createElement(
                            ...
                            this.state.weather.list.map(function (day, index) {
                                ...
                                if (index !== 0) {
                                    ...
                                    return React.createElement(
                                        "div",
                                        { className: "row forecastRow", key: day.dt, style: divStyle },
                                        React.createElement(
                                            "div",
                                            { className: "col-xs-4 forecastDate" },
                                            newDate
                                        ),
                                        React.createElement(
                                            "div",
                                            { className: "col-xs-4 forecastIcon" },
                                            React.createElement("img", { src: icon, alt: "" })
                                        ),
                                        React.createElement(
                                            "div",
                                            { className: "col-xs-4 forecastTemp" },
...
},{"react":161,"react-geosuggest":3,"whatwg-fetch":162}]},{},[163]);
